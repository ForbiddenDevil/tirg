...
class SimpleVocab(object):
  ...
  def tokenize_text(self, text):
    #print('text_model --- ', len(text), type(text), text[0])
...
class TextLSTMModel(torch.nn.Module):
  ...
  def __init__(self,
    ...
    #print('text-to-build-vocab ---- ', len(texts_to_build_vocab), type(texts_to_build_vocab), texts_to_build_vocab[1])
    for text in texts_to_build_vocab[0]:
